...
(
    ...
    entry_id BIGINT NOT NULL,
    CONSTRAINT fk_validation_input_queue_entry_entry_id FOREIGN KEY (entry_id) REFERENCES queue_entry (id) ON DELETE CASCADE
);
...
(
    ...
    entry_id BIGINT NOT NULL,
    CONSTRAINT fk_conversion_input_queue_entry_entry_id FOREIGN KEY (entry_id) REFERENCES queue_entry (id) ON DELETE CASCADE
);
...
(
    ...
    entry_id BIGINT NOT NULL,
    path     TEXT   NOT NULL,
    CONSTRAINT fk_generated_file_queue_entry_entry_id FOREIGN KEY (entry_id) REFERENCES queue_entry (id) ON DELETE CASCADE
);
